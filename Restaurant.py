...
df = pd.read_csv(r'Restaurant-Tip-Analysis/data/Unclean_Restaurant_Data.csv')
...
def avg_tip_day(df_cleaned):
    ...
    plt.savefig('Restaurant-Tip-Analysis/Visuals/avg_tip_by_day.png')
    return "Graph Successfully Saved for Question 2"

print(avg_tip_day(df_cleaned))
...
def avg_tip_by_smoker_status(df_cleaned):
    ...
    plt.savefig('Restaurant-Tip-Analysis/Visuals/tip_amt_btw_smoker_and_non_smoker.png')
    return "Graph Successfully Saved for Question 3"
...
def avg_tip_and_bill_by_size(df_cleaned):
    ...
    plt.savefig('Restaurant-Tip-Analysis/Visuals/avg_tip_by_size.png')
    ...
    plt.savefig('Restaurant-Tip-Analysis/Visuals/avg_bill_by_size.png')
    return "Graph Successfully Saved for Question 4(a) and Question 4(b)"
...
def avg_tip_by_time(df_cleaned):
    ...
    plt.savefig('Restaurant-Tip-Analysis/Visuals/avg_tip_by_time.png')
    return "Graph Successfully Saved for Question 5"
...
def relationship_total_bill_tip_party_size(df_cleaned):
    ...
    plt.savefig('Restaurant-Tip-Analysis/Visuals/correlation_total_bill_tip_party_size.png')
    return "Graph Successfully Saved for Question 6"
...
def highest_total_bill_day(df_cleaned):
    ...
    plt.savefig('Restaurant-Tip-Analysis/Visuals/total_bill_by_day.png')
